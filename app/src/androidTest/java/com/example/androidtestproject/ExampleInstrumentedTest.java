...
public class ExampleInstrumentedTest {
    ...
    public void enter_first_name(){
        Espresso.onView(withId(R.id.fname)).perform(typeText("Nishant"));
    }
    @Test
    public void enter_last_name(){
        Espresso.onView(withId(R.id.lname)).perform(typeText("Kumar"));
    }
    @Test
    public void checkName(){
        ...
        Espresso.onView(withId(R.id.display)).check(matches(withText(R.string.mName)));
    }
}
